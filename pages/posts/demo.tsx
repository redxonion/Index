...
<div className="main ts-contain cf right-sidebar">
	<div className="ts-row">
		<div className="col-8 main-content">
				...
				Browsing: <span>Theme forest</span>			</h1>
...
<Link as={`/themeforest/${post.slug}`} href={`/themeforest/[slug]`}>
<a>{post.title}</a></Link></h2><div className="post-meta-items meta-below"><span className="meta-item post-author"><span className="by">By</span> <a href="#" title="Posts by Shane Doe" rel="author">{post.author}</a></span><span className="meta-item has-next-icon date"><span className="date-link"><time className="post-date" dateTime="2021-01-14T17:46:00+00:00">{post.date}</time></span></span><span className="meta-item comments has-icon"><a href="#"><i className="tsi tsi-comment-o"></i>3</a></span></div></div>			
